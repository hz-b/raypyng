...
class TestNoAnalyze(unittest.TestCase):
    ...
    def test_0_Flux_simulations_NoAnalyze(self):
        ...
        sim.simulation_name = 'test_NoAnalyze_flux_comparison'
    ...
    def test_1_Flux_simulations_Analyze(self):
        """\n Test raypyng Analysis vs RAY-UI Analysis\n
        """
        # dirpath = "RAYPy_Simulation_test_NoAnalyze_comparison"
        # if os.path.exists(dirpath) and os.path.isdir(dirpath):
        ...
        ######################################################################
        sim.simulation_folder = '/home/simone/Documents/RAYPYNG/raypyng/test'
        sim.simulation_name = 'test_Analyze_flux_comparison'

        # repeat the simulations as many time as needed
        sim.repeat = 1

        sim.analyze = True # don't let RAY-UI analyze the results
        sim.raypyng_analysis=False # let raypyng analyze the results
    ...
    def test_2_RP_simulations_NoAnalyze(self):
        ...
        #####################################################################
        sim.simulation_folder = '/home/simone/Documents/RAYPYNG/raypyng/test'
        sim.simulation_name = 'test_NoAnalyze_rp_comparison'

        # repeat the simulations as many time as needed
        sim.repeat = 1

        sim.analyze = False # let RAY-UI analyze the results
        sim.raypyng_analysis=True # don't let raypyng analyze the results
        ## This must be a list of dictionaries
        sim.exports  =  [{elisa.Dipole:'RawRaysOutgoing'},
                        {elisa.DetectorAtFocus:['RawRaysOutgoing']}
                        ]
    ...
    def test_3_RP_simulations_Analyze(self):
        ...
        #####################################################################
        sim.simulation_folder = '/home/simone/Documents/RAYPYNG/raypyng/test'
        sim.simulation_name = 'test_Analyze_rp_comparison'
    ...
    def test_4_source_flux(self):
        ...
        # Flux RAY-UI
        repeat         = 1
        rml            = 'RAYPy_Simulation_test_Analyze_flux_comparison'
        obj            = 'DetectorAtFocus'
        source         = 'Dipole'
        nsim           = energy.shape[0]
        ...
        sim_folder = 'RAYPy_Simulation_test_NoAnalyze_flux_comparison'
    ...
    def test_5_flux(self):
        ...
        ax = self.axs[1,0]
        ax.plot(energy,self.flux_an, 'r', label='RAY-UI' )
        ax.plot(energy,self.flux, 'b', linestyle='dashed', label='raypyng' )
    ...
    def test_6_flux_percentage(self):
        ppa    = PostProcessAnalyzed()
        energy = np.arange(200, 1201,500)
        ...
        # plot percentage flux
        ax = self.axs[0,1]
        ax.plot(energy,self.flux_percent_an, 'r', label='RAY-UI' )
        ax.plot(energy,self.flux_percent, 'b', linestyle='dashed', label='raypyng' )
        ax.set_xlabel(r'Energy [eV]')
    ...
    def test_7_bandwidth(self):
        ...
        bw_result = compare_two_arrays(self.bw, self.bw_an, tol=20)
        ...
        ax.plot(energy,self.bw,'b', linestyle='dashed',label='raypyng')
        ax.set_xlabel('Energy [eV]')
    ...
    def test_8_focx(self):
        ...
        focx_result = compare_two_arrays(self.focx_an, self.focx, tol=20)
        ...
        ax.plot(energy, self.focx*um, 'b', linestyle='dashed', label='raypyng')
    ...
    def test_9_focy(self):
        ...
        focy_result = compare_two_arrays(self.focy_an, self.focy, tol=20)
        ...
        ax.plot(energy, self.focy*um, 'b', linestyle='dashed', label='raypyng')
