"""Eval for simulation_waveFiles.py — photon energy vs bandwidth and flux."""
...
if __name__ == "__main__":
    ...
    csv_path = os.path.join(this_file_dir, "RAYPy_Simulation_WaveFiles",
                            "DetectorAtFocus_RawRaysOutgoing.csv")
    group_col = None
    title = "WaveFiles: bandwidth & flux vs energy"
    ...
    if group_col:
        ...
        axs[1].legend()
    fig.tight_layout()
    out_png = os.path.join(this_file_dir, "eval_waveFiles.png")
