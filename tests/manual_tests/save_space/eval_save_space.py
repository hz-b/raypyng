"""Eval for simulation_save_space.py.
...
if __name__ == "__main__":
    ...
    csv_path = os.path.join(this_file_dir, "RAYPy_Simulation_saveSpace",
                            "DetectorAtFocus_RawRaysOutgoing.csv")
    group_col = "PG.cFactor"
    title = "save_space: bandwidth & flux vs energy"
    ...
    if group_col:
        ...
        axs[1].legend()
    fig.tight_layout()
    out_png = os.path.join(this_file_dir, "eval_save_space.png")
